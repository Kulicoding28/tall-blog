<div class="flex items-center py-4 space-x-2 font-extrabold md:py-0 p-10">
    <span class="flex items-center justify-center w-8 h-8 text-white bg-red-700 rounded-full">
        <svg class="w-auto h-5 -translate-y-px bg-red-700" viewBox="0 0 69 66" fill="none"
